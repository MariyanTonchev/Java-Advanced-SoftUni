...
public class RadioactiveMutantVampireBunnies {
    ...
    public static void main(String[] args) {
        ...
        while (++counter < cmdArgs.length && !isPlayerDead) {
            ...
            spreadBunnies(matrix, queueOfPositions);
            ...
            if (isInLair(playerRow, playerCol, matrix)) {
                break;
            }
    ...
    private static void printMatrix(char[][] finalMatrix) {
    ...
    private static void spreadBunnies(char[][] matrix, ArrayDeque<Integer> queueOfPositions) {
        ...
        for (int i = 0; i < lengthOperations; i++) {
            ...
            for (int j = 0; j < rowMovement.length; j++) {
                ...
                if (isInLair(newRow, newCol, matrix)) {
                    continue;
                }
    ...
    private static boolean isInLair(int row, int col, char[][] matrix) {
